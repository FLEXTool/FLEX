...
NSString *const kFLEXDefaultsExportExcludeImagesKey = @"com.flex.export.exclude_images";
NSString *const kFLEXDefaultsExportExcludeAnalyticsKey = @"com.flex.export.exclude_analytics";
NSString *const kFLEXDefaultsExportExcludeFirebaseAnalyticsKey = @"com.flex.export.exclude_firebase_analytics";
...
{
    return [NSArray arrayWithContentsOfFile:[self flex_defaultsPathForFile:kFLEXDefaultsNetworkHostDenylistKey]] ?: @[];
}

- (void)setFlex_networkHostDenylist:(NSArray<NSString *> *)denylist
{
    NSParameterAssert(denylist);
    [denylist writeToFile:[self flex_defaultsPathForFile:kFLEXDefaultsNetworkHostDenylistKey] atomically:YES];
}
...
- (BOOL)flex_exportExcludeImages
{
    return [self boolForKey:kFLEXDefaultsExportExcludeImagesKey];
}

- (void)setFlex_exportExcludeImages:(BOOL)exclude
{
    [self setBool:exclude forKey:kFLEXDefaultsExportExcludeImagesKey];
}

- (BOOL)flex_exportExcludeAnalytics
{
    return [self boolForKey:kFLEXDefaultsExportExcludeAnalyticsKey];
}

- (void)setFlex_exportExcludeAnalytics:(BOOL)exclude
{
    [self setBool:exclude forKey:kFLEXDefaultsExportExcludeAnalyticsKey];
}

- (BOOL)flex_exportExcludeFirebaseAnalytics
{
    return [self boolForKey:kFLEXDefaultsExportExcludeFirebaseAnalyticsKey];
}

- (void)setFlex_exportExcludeFirebaseAnalytics:(BOOL)exclude
{
    [self setBool:exclude forKey:kFLEXDefaultsExportExcludeFirebaseAnalyticsKey];
}
